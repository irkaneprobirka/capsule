...
<div class="card m-3 rounded-3" style="width: 18rem; height: 36rem;">
    <?php
    ...
    <div class="card-body">
        ...
        <div class="d-flex flex-wrap mb-3">
            ...
            <?php endif; ?>
            <?= Html::a('Подробнее', ['view', 'id' => $model->id], ['class' => 'btn btn-outline-primary opacity-50 w-100 ']) ?>
            <?= $model->is_active == 0 && $model->is_copied == 0 
                ?
                Html::a('Выложить образ', ['public', 'id' => $model->id], ['class' => 'btn btn-outline-primary w-100 mb-3 mt-3'])
                : 
                Html::tag('p', 'Образ уже в ленте', ['class' => 'link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover m-auto mt-3']) ?>
        </div>
    </div>
</div>