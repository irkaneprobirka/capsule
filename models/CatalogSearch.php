...
/**
 * CatalogSearch represents the model behind the search form of `app\models\Look`.
 */
class CatalogSearch extends Look
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'like', 'dislike', 'cost', 'user_id', 'description_id', 'is_active'], 'integer'],
